    ...
    fn load_process_signatures() -> Vec<ProcessSignature> {
        vec![
            ...
            ProcessSignature {
                ...
                name_pattern: Some(Regex::new(r"(?i)mimikatz").unwrap()),
                path_pattern: None,
                parent_pattern: None,
            ...
            ProcessSignature {
                ...
                name_pattern: Some(Regex::new(r"(?i)psexe[cs]?\.exe").unwrap()),
                path_pattern: None,
                parent_pattern: None,
                cmdline_pattern: None,
            ...
            ProcessSignature {
                ...
                name_pattern: Some(Regex::new(r"(?i)powershell").unwrap()),
                path_pattern: None,
                parent_pattern: None,
                cmdline_pattern: Some(Regex::new(r"(?i)(-enc|-e\s|encodedcommand)").unwrap()),
            ...
            ProcessSignature {
                ...
                category: ThreatCategory::Execution,
                name_pattern: Some(Regex::new(r"(?i)wmic\.exe").unwrap()),
                path_pattern: None,
                parent_pattern: Some(Regex::new(r"(?i)(cmd\.exe|powershell\.exe)").unwrap()),
                cmdline_pattern: Some(Regex::new(r"(?i)(process\s+call\s+create|/node:)").unwrap()),
            ...
            ProcessSignature {
                ...
                name_pattern: Some(Regex::new(r"(?i)schtasks\.exe").unwrap()),
                path_pattern: None,
                parent_pattern: None,
                cmdline_pattern: Some(Regex::new(r"(?i)/create").unwrap()),
            ...
            ProcessSignature {
                ...
                name_pattern: Some(Regex::new(r"(?i)(wannacry|ryuk|lockbit|blackcat|conti|revil)").unwrap()),
                path_pattern: None,
                parent_pattern: None,
                cmdline_pattern: None,
    ...
    fn load_file_signatures() -> Vec<FileSignature> {
        vec![
            FileSignature {
                ...
                severity: ThreatSeverity::Critical,
                category: ThreatCategory::CredentialAccess,
                path_pattern: Some(Regex::new(r"(?i)Windows\\System32\\config\\SAM").unwrap()),
                hash_list: vec![],
                operation_pattern: Some(Regex::new(r"(?i)(read|copy)").unwrap()),
                mitre_tactics: vec!["Credential Access".to_string()],
            ...
            FileSignature {
                ...
                severity: ThreatSeverity::Critical,
                category: ThreatCategory::CredentialAccess,
                path_pattern: Some(Regex::new(r"(?i)lsass.*\.dmp").unwrap()),
                hash_list: vec![],
                operation_pattern: Some(Regex::new(r"(?i)(create|write)").unwrap()),
                mitre_tactics: vec!["Credential Access".to_string()],
            ...
            FileSignature {
                ...
                severity: ThreatSeverity::Critical,
                category: ThreatCategory::Ransomware,
                path_pattern: Some(Regex::new(r"(?i)(README.*\.txt|DECRYPT.*\.txt|RESTORE.*\.txt|.*RANSOM.*\.txt)").unwrap()),
                hash_list: vec![],
                operation_pattern: Some(Regex::new(r"(?i)create").unwrap()),
                mitre_tactics: vec!["Impact".to_string()],
                mitre_techniques: vec!["T1486".to_string()],
                confidence: 0.99,
                recommended_actions: vec![
            ...
            FileSignature {
                ...
                severity: ThreatSeverity::High,
                category: ThreatCategory::CredentialAccess,
                path_pattern: Some(Regex::new(r"(?i)(Chrome|Firefox|Edge).*Login Data").unwrap()),
                hash_list: vec![],
                operation_pattern: Some(Regex::new(r"(?i)(read|copy)").unwrap()),
                mitre_tactics: vec!["Credential Access".to_string()],
    ...
    fn load_network_signatures() -> Vec<NetworkSignature> {
        vec![
            ...
            NetworkSignature {
                ...
                protocol_pattern: Some(Regex::new(r"(?i)tcp").unwrap()),
                mitre_tactics: vec!["Command and Control".to_string()],
            ...
            NetworkSignature {
                ...
                ip_pattern: Some(Regex::new(r"pool\..*|.*\.pool\.").unwrap()),
